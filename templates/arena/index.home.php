...
<html lang="en">
	...
	<body class="home">
		...
		<div class="container container-top">
			...
			<!-- SLIDER BLOCK -->
			<?php include(__PATH_TEMPLATE_ROOT__ . 'inc/modules/slider.block.php'); ?>
			
			<!-- NEWS BLOCK -->
			<?php include(__PATH_TEMPLATE_ROOT__ . 'inc/modules/news.block.php'); ?>
		...
		<!-- CLASSES BLOCK -->
		<?php include(__PATH_TEMPLATE_ROOT__ . 'inc/modules/classes.block.php'); ?>
		...
		<!-- MODALS -->
		<?php include(__PATH_TEMPLATE_ROOT__ . 'inc/modules/login.modal.php'); ?>
